...
export default function ArtistDashboard() {
  return (
    <div className="space-y-10">
      {/* Welcome Header */}
      <div>
        <h1 className="text-[32px] font-bold text-white mb-2 tracking-tight">Welcome Back to Dashboard</h1>
        <p className="text-gray-400 font-medium">Here's what's happening with your bookings</p>
      </div>
          ...
          <div className="bg-[#111116] border border-white/5 rounded-[32px] overflow-hidden">
            <div className="p-8 border-b border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-[#7C5CFF]/10 flex items-center justify-center text-[#7C5CFF] border border-[#7C5CFF]/20">
                   <DollarSign size={24} />
                </div>
                <div>
                  <h2 className="text-xl font-bold text-white">Incoming Offers</h2>
                  <p className="text-sm text-gray-500">3 pending offers</p>
                </div>
              </div>
              <button className="px-6 py-2.5 rounded-full bg-[#7C5CFF] text-white text-sm font-semibold hover:bg-[#6A4BE5] transition-all shadow-[0_0_20px_rgba(124,92,255,0.2)] hover:shadow-[0_0_30px_rgba(124,92,255,0.4)] animate-shine animate-pulse-glow">
                View All Offers
              </button>
            </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end">
                    ...
                    <div className="flex items-center gap-2">
                      <button className="px-5 py-2 rounded-xl bg-[#7C5CFF] text-white text-sm font-bold hover:bg-[#6A4BE5] transition-all shadow-[0_0_15px_rgba(124,92,255,0.2)] hover:shadow-[0_0_25px_rgba(124,92,255,0.4)] animate-shine animate-pulse-glow">
                        Accept
                      </button>
                      <button className="px-5 py-2 rounded-xl bg-white/[0.05] border border-white/10 text-gray-400 text-sm font-bold hover:bg-white/[0.1] hover:text-white transition-all">
                        Reject
                      </button>
                    </div>
                  </div>
