...
function SearchContent() {
    ...
    React.useEffect(() => {
        ...
        if (currentQueryStr !== newQueryStr) {
            router.replace(`/dashboard/explore?${newQueryStr}`, { scroll: false });
        }
    ...
    const handleApplyFilters = () => {
        ...
        router.push(`/dashboard/explore?${newQuery.toString()}`, { scroll: false });
    };
    ...
    const handleResetFilters = () => {
        ...
        router.push('/dashboard/explore', { scroll: false });
    };
    ...
    return (
        <main className="p-4 sm:p-6 md:p-8 lg:p-10 w-full pb-20 font-sans">
                                ...
                                onChange={React.useCallback((updates: any) => {
                                    ...
                                    if (updates.type) {
                                        ...
                                        if (updates.type !== currentType) {
                                            ...
                                            router.replace(`/dashboard/explore?${newQuery.toString()}`, { scroll: false });
                                        }
                                    }
                                }, [searchParams, router])}
