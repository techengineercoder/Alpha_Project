...
export default function MessagesDashboardPage() {
  ...
  return (
    <div className="h-[calc(100vh-68px)] lg:h-screen flex flex-col bg-[#050505] text-white overflow-hidden font-sans relative">
      ...
      {/* Top Header Row (Desktop only, matches design system) */}
      <header className="hidden lg:flex items-center justify-between px-8 py-4 border-b border-zinc-900/60 bg-[#050505] shrink-0 h-[72px]">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
            <MessageSquare className="h-5 w-5 text-[#00A5E5]" />
            Messages
          </h1>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative w-64">
            ...
            <input
              ...
              className="w-full h-10 pl-10 pr-4 rounded-full bg-[#121214] border border-zinc-800 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-zinc-700 focus:ring-1 focus:ring-zinc-700 transition-colors font-sans"
            />
          </div>
          ...
          <button 
            onClick={() => router.push("/artist/availability")}
      ...
      <div className="flex-1 flex overflow-hidden w-full relative">
        ...
        `}>
          ...
          {/* Mobile Header Title */}
          <div className="p-4 flex items-center justify-between border-b border-zinc-900 lg:hidden">
            ...
            <button 
              onClick={() => router.push("/artist/availability")}
              className="text-xs bg-[#00A5E5] text-white px-3 py-1.5 rounded-lg font-semibold"
            >
              Update
            </button>
          </div>
              ...
              <div className="p-4 border-t border-zinc-900/60 bg-[#050505]">
                ...
                >
                  ...
                  <button
                    ...
                    className="h-8 px-4 rounded-xl bg-[#00A5E5] hover:bg-[#009bde] text-white font-bold text-xs shrink-0 cursor-pointer transition-colors shadow-sm"
                  >
                    Create Offer
                  </button>
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${inputMessage.trim() 
                        ? "bg-[#00A5E5] text-white shadow-sm" 
