...
export default function TermsOfServicePage() {
  ...
  const matchedTerm = termsData?.results?.find((item: any) => item.slug === "terms-of-service");
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#A1A1AA] text-lg">
              Effective Date: {new Date(matchedTerm.updated_at).toLocaleDateString("en-US", { month: "long", year: "numeric" })}
            </p>
          </div>
