        ...
        <table className="w-full border-collapse text-left min-w-[768px]">
          <thead>
            <tr className="border-b border-white/5 text-xs font-semibold text-[#71717A] uppercase tracking-wider select-none bg-transparent">
              ...
              <th className="py-4 px-6 text-left pl-12">Status</th>
            </tr>
          </thead>
                ...
                >
                  ...
                  <td className="py-5 px-6 text-center">
                    <div className="inline-block">
                      <span className={`px-3.5 py-1 rounded-full text-xs font-semibold ${getRoleBadgeStyle(member.role)}`}>
                        {member.role}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="py-5 px-6">
                    <div className="flex items-center justify-between gap-4 max-w-[340px] ml-auto">
                      <div className="flex-1 text-left">
                        <span
                          onClick={() => onToggleStatus(member.id)}
                          title="Click to toggle status (Demo)"
                          className={`cursor-pointer select-none inline-flex items-center gap-2 pl-4 py-1.5 rounded-full text-xs font-semibold w-40 sm:w-44 transition-all border
                            ${
