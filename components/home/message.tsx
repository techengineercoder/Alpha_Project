                            ...
                            <div className="px-4 pb-4 pt-2 bg-[#0F0F17] flex-shrink-0 border-t border-white/[0.05]">
                                <div className="flex items-center gap-2 bg-[#1A1A2E] rounded-2xl px-4 py-2 border border-white/[0.07] focus-within:border-[#7C5CFF]/60 transition-colors">
                                    ...
                                    <button
                                        ...
                                        disabled={isAsking || !newMessage.trim()}
                                        aria-label="Send message"
                                        className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-[#7C5CFF] to-[#6644ee] hover:from-[#8B6BF5] hover:to-[#7C5CFF] disabled:opacity-30 disabled:cursor-not-allowed active:scale-90 transition-all duration-150 shadow-[0_2px_10px_rgba(124,92,255,0.4)]"
                                    >
                                        <Send size={14} className="text-white" />
                                    </button>
                                </div>
