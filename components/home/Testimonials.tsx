...
export function Testimonials() {
  ...
  return (
    <section className="w-full bg-[#0b0b0f] py-20 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col items-center mb-16">
        <motion.h2
        ...
        <div className="flex w-max animate-marquee hover:[animation-play-state:paused]">
          ...
          <div className="flex gap-6 px-3">
            {duplicatedTestimonials.map((testimonial, i) => (
              <div
                key={`first-${i}`}
                className="w-[320px] md:w-[420px] bg-[#121218] border border-white/5 p-8 rounded-[24px] flex flex-col justify-between shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:-translate-y-2 hover:border-[#7C5CFF]/30 hover:bg-[#1A1A22] cursor-default"
              >
                <div>
